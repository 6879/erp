...
<?php echo app('translator')->get('lang.exam_schedule'); ?> <?php echo app('translator')->get('lang.create'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('mainContent'); ?>
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.exam_schedule'); ?> <?php echo app('translator')->get('lang.create'); ?> </h1>
            <div class="bc-pages">
                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th width="10%"><?php echo app('translator')->get('lang.class_Sec'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(@$assign_subject->className !=""? @$assign_subject->className->class_name:""); ?>(<?php echo e(@$assign_subject->section !=""?@$assign_subject->section->section_name:""); ?>)</td>
                            <?php $__currentLoopData = $exam_periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam_period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                            ...
                            <td>
                                <?php if(@$assigned_routine == ""): ?>
                                    <?php if(@$assigned_routine_subject == ""): ?>
                                        ...
                                        <div class="col-lg-6">
                                            <a href="<?php echo e(route('add-exam-routine-modal', [$assign_subject->subject_id, $exam_period->id, $class_id, $assign_subject->section_id, $exam_id,$section_id_all])); ?>" class="primary-btn small tr-bg icon-only mr-10 modalLink" data-modal-size="modal-md" title="<?php echo app('translator')->get('lang.create'); ?> <?php echo app('translator')->get('lang.exam_routine'); ?>">
                                ...
                                <?php else: ?>
                                    <div class="col-lg-6">
                                        ...
                                        <a href="<?php echo e(route('edit-exam-routine-modal', [$assign_subject->subject_id, $exam_period->id, $class_id, $assign_subject->section_id, $exam_id, $assigned_routine->id,$section_id_all])); ?>" class="modalLink" data-modal-size="modal-md" title="<?php echo app('translator')->get('lang.edit'); ?> <?php echo app('translator')->get('lang.exam_routine'); ?>">
                                            <span class="ti-pencil-alt" id="addClassRoutine"></span>
                                        </a>
                                        <a href="<?php echo e(route('delete-exam-routine-modal', [$assigned_routine->id,$section_id_all])); ?>" class="modalLink" data-modal-size="modal-md" title="<?php echo app('translator')->get('lang.delete'); ?> <?php echo app('translator')->get('lang.exam_routine'); ?>">
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edubangl/infinitytechltd.bou.education/resources/views/backEnd/examination/exam_schedule_create.blade.php ENDPATH**/ ?>