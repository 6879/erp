    ...
    >
            <div class="container box-1420">
                ...
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>/home">
                    ...
                    <img class="w-75"
                         src="<?php echo e(asset($setting->logo ? $setting->logo : 'https://layerdrops.com/zimed/assets/images/logo-1-1.png')); ?>"
                        ...
                        <?php if(moduleStatusCheck('Saas')== FALSE): ?>
                                ...
                                <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li class="nav-item submenu_left_control">
                                        <a class="nav-link" href="#" style="background:white;"><?php echo e($menu->title); ?></a>
                                        <ul class="sumbmenu">
                                    ...
                                    <?php else: ?>
                                    <li class="nav-item">
                                        <a class="nav-link" style="font-size:18px;font-weight:bold;color:white!important;" <?php echo e($menu->is_newtab ? 'target="_blank"' : ''); ?>
...
</html><?php /**PATH /home/edubangl/infinitytechltd.bou.education/modify/resources/views/frontEnd/home/front_master.blade.php ENDPATH**/ ?>