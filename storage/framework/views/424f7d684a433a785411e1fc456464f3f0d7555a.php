                ...
                <div class="col-lg-12">
                    <ul class="nav nav-tabs mb-50 ml-0" role="tablist">
                        <?php if($course->overview): ?>
                            <li class="nav-item">
                                <a class="nav-link active" href="#overviewTab" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.overview'); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if($course->outline): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#outlineTab" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.outline'); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if($course->prerequisites): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#prerequisitesTab" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.prerequisites'); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if($course->resources): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#resourcesTab" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.resources'); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if($course->stats ): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#statsTab" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.stats'); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="title"><?php echo app('translator')->get('lang.related_courses'); ?></h3>
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edubangl/infinitytechltd.bou.education/resources/views/frontEnd/home/light_course_details.blade.php ENDPATH**/ ?>