            ...
            <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if(userPermission(494))
                                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'chairman-message-update', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }} 
                            @endif
                                <div class="white-box">
                                            <div class="row"> 
                                                <div class="col-lg-6"> 
                                                    <div class="input-effect">
                                                        <input class="primary-input form-control" type="text" name="name" autocomplete="off" value="{{isset($links)?@$links->name:''}}">
                                                        <label>Name</label>
                                                ...
                                                <div class="col-lg-6"> 
                                                    <div class="input-effect">
                                                        <input class="primary-input form-control" type="text" name="designation" autocomplete="off"  value="{{isset($links)?@$links->designation:''}}" >
                                            ...
                                            <div class="row mt-25">  
                                                <div class="col-lg-12 mt-20"> 
                                                    <div class="input-effect">
                                                        <input class="primary-input form-control" type="text" name="message" autocomplete="off" value="{{isset($links)?@$links->message:''}}">
                                                        <label>Message </label>
                                                        <span class="focus-border"></span>
                                                    </div> 
                                                </div>  
                                            ...
                                            <div class="row mt-25">                                                 
                                               <script src="{{asset('public/backEnd/')}}/vendors/js/print/2.1.1_jquery.min.js"></script>
                                                ...
                                                <div class="col-lg-4 mt-25" style="display:none"> 
