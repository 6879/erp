...
<header style="background:#797b7c;">
    <div class="owl-carousel owl-theme">
        <div class="item">
            <img src="{{url($homePage->image)}}" alt="images not found">
            <div class="cover">
                <div class="container">
                    <div class="header-content">
                        <div class="line"></div>
                        <h2>{{$homePage->title}}</h2>
                        <h1>{{$homePage->long_title}}</h1>
                        <h4>{{$homePage->short_description}}</h4>
            ...
            <div class="single-info row mt-40 align-items-center">
                <div class="col-lg-3 col-md-12 text-center pr-lg-0 info-left border shadow" data-aos="fade-right">
                    <div class="info-thumb">
                        <img src="{{url('/')}}/public/uploads/settings/chairman.jpg" class="img-fluid" alt="Chairman" style="width:198px;">
                        <p>
                            A S M Jamaluddin 
                            <br>
                    ...
                    <div class="col-lg-3 notice-board-area bg-light border shadow" style="height:340px;" data-aos="fade-left">
                        <div class="row">
                            <div class="col-lg-12 bg-success text-center">
                                <h3 class="title text-white mt-2">@lang('lang.notice_board')</h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
              ...
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link active" href="#client1" data-toggle="tab">
                    <img class="drop-shadow" src="<?php echo url('/') ?>/public/uploads/settings/bn-img/sabbir.png" alt="Client Image">
                  </a>
                </li>
                <li class="nav-item">
                  ...
                  <div class="tab-pane fade show active" id="client1">
                    ...
                    <div class="client-desc border shadow bg-light d-flex align-items-center">
                      <div class="text mx-auto">
                        <h4 class="mb-10"> Md Sabbir Hossain </h4>
                        <h6>Students , Class one</h6>
                        <p>  Until we were in school, we did not know the pain of leaving behind something, but now I know the problem distance creates between us to some of our school memories. </p>
                      </div>
                    </div>
                  </div>
                  <!-- Single Client End -->
